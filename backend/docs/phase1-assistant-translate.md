...
- `TRANSLATE_WEB_FALLBACK_ENABLED`（默认 `true`，本地翻译失败时启用网络兜底）
- `TRANSLATE_WEB_FALLBACK_URL`（默认 `https://translate.googleapis.com/translate_a/single`）
- `TRANSLATE_WEB_FALLBACK_TIMEOUT_MS`
- `TRANSLATE_WEB_FALLBACK_RETRY_MAX`
